    ...
    InModuleScope 'MSFT_xGroupResource' {
        Describe 'xGroup Unit Tests' {
            ...
            Context 'Get-TargetResource' {
                ...
                It 'Should call Assert-GroupNameValid with the group name' {
            ...
            Context 'Test-IsLocalMachine' {
                ...
                It 'Should return false if custom local IP address provided and Get-CimInstance does not contain matching IP address' {
            ...
            <#
                Get-Group, Add-GroupMember, Remove-GroupMember, Clear-GroupMembers, Save-Group, and
                Remove-Group cannot be unit tested because they are wrapper functions for a .NET class function calls
            #>
